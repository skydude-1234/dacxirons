...
public class FairyScepterItemModel extends GeoModel<FairyWandStaff> {
    public ResourceLocation getAnimationResource(FairyWandStaff animatable) {
        return ResourceLocation.fromNamespaceAndPath("dungeons_and_combat", "animations/fairystaffanimated.animation.json");
    }

    public ResourceLocation getModelResource(FairyWandStaff animatable) {
        return ResourceLocation.fromNamespaceAndPath("dungeons_and_combat", "geo/fairystaffanimated.geo.json");
    }

    public ResourceLocation getTextureResource(FairyWandStaff animatable) {
        return ResourceLocation.fromNamespaceAndPath("dungeons_and_combat", "textures/item/fairy_staff_animated.png");
    }
}
