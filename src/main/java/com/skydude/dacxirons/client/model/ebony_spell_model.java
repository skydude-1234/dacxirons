...
public class ebony_spell_model<T extends Entity> extends EntityModel<T> {
	...
	public ebony_spell_model(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 94).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
		...
		PartDefinition head_r1 = head.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(90, 46).mirror().addBox(-8.5F, -6.0F, 0.0F, 17.0F, 15.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, -11.0F, 1.0F, -1.8326F, 0.0F, 0.0F));
		...
		PartDefinition body_r1 = body.addOrReplaceChild("body_r1", CubeListBuilder.create().texOffs(70, 39).mirror().addBox(-2.0221F, 0.4658F, -2.0F, 3.0F, 10.0F, 4.0F, new CubeDeformation(0.78F)).mirror(false), PartPose.offsetAndRotation(3.5F, 9.5F, 0.0F, 0.0F, 0.0F, -0.2182F));

		PartDefinition body_r2 = body.addOrReplaceChild("body_r2", CubeListBuilder.create().texOffs(70, 39).addBox(-0.9779F, 0.4658F, -2.0F, 3.0F, 10.0F, 4.0F, new CubeDeformation(0.78F)), PartPose.offsetAndRotation(-3.5F, 9.5F, 0.0F, 0.0F, 0.0F, 0.2182F));

		PartDefinition body_r3 = body.addOrReplaceChild("body_r3", CubeListBuilder.create().texOffs(25, 70).addBox(-3.0F, -7.0F, -0.5F, 6.0F, 14.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 15.0F, -3.5F, -0.2618F, 0.0F, 0.0F));
