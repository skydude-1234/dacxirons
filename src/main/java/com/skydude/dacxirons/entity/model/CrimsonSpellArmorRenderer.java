...
public class CrimsonSpellArmorRenderer extends GeoArmorRenderer<TectonicCrestArmorItem> {
    public CrimsonSpellArmorRenderer(TectonicCrestArmorModel tectonicCrestArmorModel) {
        super(new TectonicCrestArmorModel());
        this.addRenderLayer(new TectonicCrestArmorLayer(this));
    ...
    public RenderType getRenderType(TectonicCrestArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
        return RenderType.armorCutoutNoCull(this.getTextureLocation(animatable));
    }
}
